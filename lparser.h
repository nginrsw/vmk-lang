...
typedef struct expdesc {
  expkind k;
  union {
    vmk_Integer ival;    /* for VKINT */
    vmk_Number nval;  /* for VKFLT */
...
VMKI_FUNC lu_byte vmkY_nvarstack (FuncState *fs);
VMKI_FUNC void vmkY_checklimit (FuncState *fs, int v, int l,
                                const char *what);
VMKI_FUNC LClosure *vmkY_parser (vmk_State *L, ZIO *z, Mbuffer *buff,
